...
g++ -O3 -c cheetah_ext.cpp -shared -fPIC  -I./ -I../dials-v1-10-2/base/include/python2.7 -I../dials-v1-10-2/base/lib/python2.7/site-packages/numpy/core/include/ -I../dials-v1-10-2/modules/boost
g++ -shared cheetah_ext.o  -o cheetah_ext.so -L../dials-v1-10-2/build/lib -lboost_python -lboost_numpy ./peakfinders.o 
...
public:
	...
	boost::python::list run(int asic_nx, int asic_ny, 
		...
		long nPeaks = algorithm == 8 ?  peakfinder8<T>(&peaklist, data_ptr, mask, pix_r,
			...
			: peakfinder6<T>(&peaklist, data_ptr, mask, asic_nx, asic_ny, nasics_x, nasics_y,
							 hitfinderADCthresh, hitfinderMinSNR, hitfinderMinPixCount,
